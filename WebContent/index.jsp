      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
          	<c:set var="test" value="Main"/>
          	<c:choose>
          		<c:when test="${exceptionMsg eq null}">
          			<c:set var="msg" value="main page"/>
          		</c:when>
          		<c:when test="${exceptionMsg ne null}">
          			<c:set var="msg" value="${exceptionMsg }"/>
          		</c:when>
          	</c:choose>
            <h1>${test }</h1>
